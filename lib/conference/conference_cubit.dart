...
import 'package:flutter_twillio/conference/participant_widget.dart';
...
class ConferenceCubit extends Cubit<ConferenceState> {
  ...
  void _onConnected(Room room) {
    log('[ APPDEBUG ] ConferenceRoom._onConnected => state: ${room.state}');
  ...
  void _onConnectFailure(RoomConnectFailureEvent event) {
    log('[ APPDEBUG ] ConferenceRoom._onConnectFailure: ${event.exception}');
  }
